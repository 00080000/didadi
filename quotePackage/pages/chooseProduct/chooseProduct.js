...
Page({
  ...
  navigate(e){
    if(this.data.product[e.currentTarget.dataset.index].type=="singleProduct"){
      wx.navigateTo({
        url: '/quotePackage/pages/editChoosedSingleProduct/editChoosedSingleProduct',
      })
    } else if(this.data.product[e.currentTarget.dataset.index].type=="combinationProduct"){
      wx.navigateTo({
        url: '/quotePackage/pages/editChoosedCombinationProduct/editChoosedCombinationProduct',
      })
    } else if(this.data.product[e.currentTarget.dataset.index].type=="customProduct"){
      wx.navigateTo({
        url: '/quotePackage/pages/editChoosedCuntomProduct/editChoosedCuntomProduct',
      })
    } else if(this.data.product[e.currentTarget.dataset.index].type=="feeName"){
      wx.navigateTo({
        url: '/quotePackage/pages/editFee/editFee',
        })
    }
  },
  cancel(){
